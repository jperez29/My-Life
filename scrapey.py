...
def scrape():
    ...
    latin_america = ["USA", "Belize", "Costa Rica", "El Salvador",
    ...
    '''PERCENTAGE OF COVID-19 CASES IN LATIN AMERICA INCLUDING 
    USA COMPARED TO THE REST OF THE WORLD'''
    for lst in americas_data:
        for i,num in enumerate(lst[2:]):
            lst[i+2]= round((num / lst_world[i+1]) * 100, 4)     
